...
import 'package:textile/views/drawer/Search_Importer_By_Product_Specification/list_pages.dart';
import 'package:textile/views/drawer/drawer.dart';
import 'package:textile/widgets/custom_app_bar.dart';

class SearchImporterByProductSpecification extends StatelessWidget {
  const SearchImporterByProductSpecification({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const SearchImporterByProductSpecificationListPage(),
    );
  }
}
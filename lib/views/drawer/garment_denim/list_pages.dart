...
class GarmnetDENIMListPage extends StatefulWidget {
  ...
  @override
  State<GarmnetDENIMListPage> createState() => _GarmnetDENIMListPageState();
}

class _GarmnetDENIMListPageState extends State<GarmnetDENIMListPage> {
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Container(
                          ...
                          child: Text(
                            'Total: ${controller.totalRecords.value} | Showing: ${controller.filteredBuyers.length}',

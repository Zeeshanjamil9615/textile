...
class CustomDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isGarmentDanim = currentRoute.contains('GarmentDanim') || Get.isRegistered<GarmentDenimController>();
    final isSearchDanim = currentRoute.contains('SearchDanim') || Get.isRegistered<SearchDanimController>();
    final isEmailImportersCityWise = currentRoute.contains('EmailImportersCityWise') || Get.isRegistered<EmailImportersCityWiseController>();
    final isEmailImportersCountryWise = currentRoute.contains('EmailImportersCountryWise') || Get.isRegistered<EmailImportersCountryWiseController>();
    
    final isSearchImporterByProductSpecification = currentRoute.contains('SearchImporterByProductSpecification') || Get.isRegistered<SearchImporterByProductSpecificationController>();
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
                ...
                child: Row(
                  children: [
                    const CircleAvatar(
                      ...
                      child: Icon(Icons.person, size: 40, color: Color(0xFF4A9B9B)),
                    ),
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('admin@textile.com', style: TextStyle(color: Colors.white70, fontSize: 12)),
                        ],
                      ),
                    ),
                  ],
            ...
            _DrawerItem(icon: Icons.checkroom, title: 'Garment Socks Knitted',
            ...
            _DrawerItem(icon: Icons.search, title: 'Search Garment Importer By Product Specification', 
            isSelected: isSearchGarmentImporter,
               onTap: () {
                Get.back();
                Get.off(() => const SearchGarmentImporterByProductSpecification());
              }
            ),
            _DrawerItem(icon: Icons.inventory, title: 'Garment Denim', isSelected: isGarmentDanim,
            ...
            _DrawerItem(icon: Icons.search, title: 'Search Denim Importer By Product Specification', 
            ...
            _DrawerItem(icon: Icons.email, title: 'Email Importers City Wise',
            ...
            _DrawerItem(icon: Icons.flag, title: 'Email Importers Country Wise', isSelected: isEmailImportersCountryWise,
...
onTap: () {
            ...
            _DrawerItem(icon: Icons.map, title: 'Importers on Google Map', onTap: () => Get.back()),
            _DrawerItem(icon: Icons.category, title: 'Search Importer By Product Specification', 
            ...
            _DrawerItem(icon: Icons.update, title: 'Update Data',isSelected: isUpdateData,

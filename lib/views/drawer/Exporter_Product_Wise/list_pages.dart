...
import 'package:textile/views/drawer/Exporter_Product_Wise/Exporter_card.dart';
import 'package:textile/widgets/colors.dart';
import 'package:textile/widgets/filter_empty_state.dart';

class ExporterproductwiseListPage extends StatefulWidget {
  const ExporterproductwiseListPage({Key? key}) : super(key: key);

  @override
  State<ExporterproductwiseListPage> createState() =>
      _ExporterproductwiseListPageState();
}

class _ExporterproductwiseListPageState extends State<ExporterproductwiseListPage> {
  ...
  Widget build(BuildContext context) {
    // Try to find either controller - works with both ExportersController and TextileExportersController
